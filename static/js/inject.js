// Yandex.Metrika — counter 109209486
(function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};
m[i].l=1*new Date();
for(var j=0;j<document.scripts.length;j++){if(document.scripts[j].src===r){return;}}
k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}
)(window,document,'script','https://mc.yandex.ru/metrika/tag.js','ym');
ym(109209486,'init',{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});

// Market-Place / MPSU ads for avto-fakt.vercel.app
// Articles only: horizontal after 1st, 5th, and 9th safe paragraphs, corner sticker
(function () {
  var MPSU_SCRIPT_SRC = 'https://statika.mpsuadv.ru/scripts/11525.js';
  ...
  function initMpsuAds() {
    ...
    loadMpsuScript();
    // Rotator Static ZBT avto-fakt.vercel.app horizontal 1 #44050
    insertAfterParagraph(44050, 1);
    // Rotator Static ZBT avto-fakt.vercel.app horizontal 2 #44051
    insertAfterParagraph(44051, 5);
    // Rotator Static ZBT avto-fakt.vercel.app horizontal 3 #44052
    insertAfterParagraph(44052, 9);
    // Rotator Recom V avto-fakt.vercel.app #44053
    insertFloatingWidget(44053);
  }
